...
const PATROL_PATHS: [number, number][][] = [
  [[-16, -8], [-8, -16], [10, -12], [16, -4], [10, 12], [-8, 16]],
  [[16,  6], [12,  16], [-8, 14], [-16,  4], [-12, -10], [8, -14]],
  [[-12,  2], [-6, -12], [8,  -8], [16,   2], [8,  12], [-6, 10]],
  [[8, -14], [16, -4], [10, 12], [0, 16], [-12, 8], [-14, -4]],
  [[-8, 12], [-16, 0], [-10, -12], [4, -14], [14, 2], [10, 14]],
];
